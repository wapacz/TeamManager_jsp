...
/*
    // Create form
    $form = $("<div>").addClass("ui-widget");
    $form1 = $("<form>");
    $form.append($form1);
    
    $title = $("<div>");
    $title.append("<a>").text("Title");
    $title.append($("<input>").attr({"id": "title", "type": "text"}));
    $form1.append($title);
    
    $description = $("<div>");
    $description.append("<a>").text("Description");
    $description.append($("<input>").attr({"id": "description", "type": "text"}));
    $form1.append($description);
    
    $type = $("<div>");
    $type.append("<a>").text("Type");
    $type.append($("<input>").attr({"id": "type", "type": "text"}));
    $form1.append($type);
    ...
    $button = $("<button>").text("Confirm").button({
        icon: {
